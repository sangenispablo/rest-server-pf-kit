      ...
      init: function init(opt) {
        ...
        return this.each(function () {
          if (!$(this).data('colorpickerId')) {
            ...
            cal.find('span').bind('mousedown', downIncrement).end().find('>div.colorpicker-current-color').bind('click', restoreOriginal);
            ...
            cal.find('div.colorpicker-submit').bind('mouseenter', enterSubmit).bind('mouseleave', leaveSubmit).bind('click', clickSubmit);
